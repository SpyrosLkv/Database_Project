...
CREATE TABLE IF NOT EXISTS `semester_project`.`Authors` (
  `Author_id` INT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `semester_project`.`Belongs in` (
  ...
  CONSTRAINT `fk_Thematic_Category`
...
CREATE TABLE IF NOT EXISTS `semester_project`.`Keywords` (
  `Keyword_id` INT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `semester_project`.`School - Library` (
  `Library_id` INT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `semester_project`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `semester_project`.`user` (
...
-- -----------------------------------------------------
-- Table `semester_project`.`user_1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `semester_project`.`user_1` (
  `username` VARCHAR(16) NOT NULL,
  `email` VARCHAR(255) NULL,
  `password` VARCHAR(32) NOT NULL,
  `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP);
